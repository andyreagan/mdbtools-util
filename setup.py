...
setup(
    ...
    project_urls={
        # 'Documentation': 'https://mdbtools-util.readthedocs.io/',
        # 'Changelog': 'https://mdbtools-util.readthedocs.io/en/latest/changelog.html',
    ...
    # entry_points={
    #     'console_scripts': [
    #         'mdbtools-util = mdbtools_util.cli:main',
    #     ]
    # },
)
